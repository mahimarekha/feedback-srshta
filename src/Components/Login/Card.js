      ...
      <div>
        <div className="flex-container center">
          <div className="item-1">
            ...
            <div className="middle-text">Reliable Data</div>
          ...
          <div className="item-2">
            ...
            <div className="middle-text">Scitific Analysis</div>
            <div className="footer-text">
          ...
          <div className="item-3">
            ...
            <div className="middle-text">Tailor made Solutions</div>
            <div className="footer-text">
              <p>
                Access data everywhere, without compromising with mobile
                security
              </p>
            </div>
          </div>
